...
plot <- ggplot(data, aes(x = date, y = track.popularity, label = track.name)) +
  geom_smooth() +
  theme_classic() +
  labs(title="The popularity of Tyler, the Creator over time.", x="", y="Popularity")
...
<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/3WQlJpaUUbGtUqAskvGA7c?utm_source=generator" width="100%" height="80" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/5hVghJ4KaYES3BFUATCYn0?utm_source=generator" width="100%" height="80" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
...
<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/3v6SdZsS8zR6Go257tldbB?utm_source=generator" width="100%" height="80" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/5B0kgjHULYJhAQkK5XsMoC?utm_source=generator" width="100%" height="80" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
...
Overall, the loudness in Tylers albums seems to be increasing again but shows some periodic behavior. When extrapolating, it would therefore be safe to assume that the next album of Tyler has a high chance of being less loud.
...
All in all, these features used lead to quite successful clustering of the two albums which means they form their own separate entities. I suspect that this also applies for different pairs of albums and that all albums of Tyler form entities of their own, that can be successfully distinguished using track-level features. Unfortunately, we can not conclude this with certainty as this experiment does not really have external validity. It does given an indication though.


### Conclusion
From the research done so far, we can definitely say that almost all discussed parameters have changed significantly over time. Firstly, we can conclude that the overall valence of the albums is increasing over time. Besides that, the musical variety of the songs when it comes to timbre and chroma seems to show the same behavior. This means that, from a computational musicology sense, that Tyler's music is becoming more happier in tone as well as more varied. Besides that, we looked at the loudness of each album of Tyler, here we saw that this parameter showed cyclic behavior. Then we looked at the distribution of tempi in each of Tyler's albums. We saw there that the tempo distribution of the albums have been getting less clustered over time with a less 'central' preference. Lastly, we tried clustering two albums of Tyler. We were very successful in doing which gave an indication that each album of Tyler forms their own 'entity'.

This, of course, begs the question: Who could these conclusions benefit, and how? Well, too be honest, this is hard too say. This is because in this portfolio, we really only looked at one artist. Every artists is different and to say that Tyler's evolution is more important would not necessarily be true. So, I would say that no one *really* benefits from these conclusions. But, this does not take away that its interesting to see that the observed evolution of an artist corresponds with the evolution we found in the data.

All in all, what can we say about a possible future album of Tyler? If we would simply extrapolate our data, then we could say that the overall valence and musical variety (in chroma, tempo and timbre) of Tyler's new album would even be higher, with a lower overall loudness. However, it is never that simple. Because, at the end of the day, Tyler will simply create whatever he thinks sounds good at that time, which is influenced by factors which we simply can't measure. It could be very much the case that a higher valence and musical variety or lower loudness is not what Tyler is looking for in his next album. However, we can say that with all the experience that Tyler has acquired in his journey so far, that it will definitely be worth listening to.
